    ...
    <div className={`w-full ${maxWidthClass} mx-auto py-2`} aria-hidden="true">
      ...
      <div
        style={{
          height: 1,
          background:
            "linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,92,193,0.7) 15%, rgba(34,123,237,0.8) 50%, rgba(0,92,193,0.7) 85%, rgba(0,0,0,0) 100%)",
          opacity,
        }}
      />
      ...
      <div
        style={{
          ...
          filter: "blur(6px)",
          background:
            "linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,92,193,0.20) 20%, rgba(34,123,237,0.25) 50%, rgba(0,92,193,0.20) 80%, rgba(0,0,0,0) 100%)",
